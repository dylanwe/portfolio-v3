	...
	return (
		<div className="fixed top-8 right-8">
			<button
				...
				className="ml-auto bg-neutral-50 border border-neutral-300 text-neutral-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block p-2.5 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 backdrop-blur-xl bg-opacity-80 dark:bg-opacity-80"
				type="button"
