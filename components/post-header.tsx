...
const PostHeader = ({
	...
	return (
		<>
			...
			<div className="mb-2 text-lg text-neutral-800 dark:text-neutral-200 text-center md:text-left">
				<DateFormatter dateString={date} />
			</div>
			<div className="mb-6 text-neutral-500 dark:text-neutral-400 text-center md:text-left space-x-2">
			...
			<Link
				href={repository}
				target="_blank"
				className=" bg-primary-500 hover:bg-primary-600 transition-colors p-3 rounded-lg text-white shadow-lg inline-flex space-x-2 mb-8 md:mb-16"
			>
				<svg
